...
//	 */
//	public InfoFrame(MainFrame mainFrame, DAO dao, int id) {
...
//		setBounds(	(int) (MainFrame.ScreenSize.width * 0.35),	// X position
//					(int) (MainFrame.ScreenSize.height * 0.3),	// Y position
//					(int) (MainFrame.ScreenSize.width * 0.3),	// Width
//					(int) (MainFrame.ScreenSize.height * 0.45));	// Height
//		setResizable(false);
//
...
//		gbl = MainFrame.createGridBagLayoutFull(2, 2);
...
//		gbl = MainFrame.createGridBagLayout(gblSize[0], gblSize[1], new int[] {1}, new int[] {gblSize[1] - 1});
//		form.setLayout(gbl);
//
//		// NOMBRE
...
//		gbc = MainFrame.createGridBagConstraints(0, rowNumber);
//		form.add(lblNombre, gbc);
//
//		nameTextField = new JTextField();
//		nameTextField.setText(c.getName());
//		nameTextField.setEditable(false);
//		gbc = MainFrame.createGridBagConstraints(1, rowNumber++);
//		if (tipo.equals(Contact.Type[0]))
//			gbc.gridwidth = 3;
...
//			gbc = MainFrame.createGridBagConstraints(2, rowNumber);
...
//			gbc = MainFrame.createGridBagConstraints(3, rowNumber);
...
//		gbc = MainFrame.createGridBagConstraints(x, y);
//		if (tipo.equals(Contact.Type[2]))
//			gbc.gridheight = 2;
//		gbc.fill = GridBagConstraints.BOTH;
...
//
//		gbl = MainFrame.createGridBagLayoutFull(4, 1);
...
//
//		gbl = MainFrame.createGridBagLayoutFull(3, 0);
...
//			gbc = MainFrame.createGridBagConstraints(i + 1, 0);
//			gbc.fill = GridBagConstraints.HORIZONTAL;
