 ...
 * MSG.<br><br>
 * 
 * Clase estática para mostrar mensajes mediante JOptionPane.
 * 
 * @since 2022-05-05
 * @author Q
 */
public class MSG extends JOptionPane { // CLASE FINALIZADA
	...
	/**
	 * Muestra un panel de confirmación con opción 'OK'.
	 * 
	...
	/**
	 * Muestra un panel de confirmación con las opciones 'Sí / No'.
	 * 
	 * @param msg the message to show
	 * @return the index of the chosen option
	 */
	...
	/**
	 * Muestra un panel de confirmación con las opciones 'Sí / No / Cancelar'.
	 * 
	 * @param msg the message to show
	 * @return the index of the chosen option
	 */
