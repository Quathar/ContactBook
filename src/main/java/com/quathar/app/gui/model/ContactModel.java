 ...
 * ContactModel.<br><br>
 * 
 * Modelo para manipular la informaci�n de la tabla <b>contactos</b> de la BBDD.
 * 
 * @see GeneralModel
 * @since 2022-04-10
 * @author Q
...
public class ContactModel extends GeneralModel { // CLASE FINALIZADA
	 ...
	 */
	private final String[] ColumnNames = {"ID", "NOMBRE", "DIRECCI�N", "NOTAS"};
	 ...
	 */
	private final String TABLE = DB.ContactsTitle;
