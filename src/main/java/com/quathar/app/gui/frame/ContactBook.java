...
import com.quathar.app.gui.component.RoundJTextField;
import com.quathar.app.gui.game.TresEnRaya;
import com.quathar.app.gui.component.ChangerComboBox;
import com.quathar.app.gui.table.ContactHobbyTable;
import com.quathar.app.gui.table.ContactTable;
import com.quathar.app.gui.table.HobbyTable;
import com.quathar.app.gui.table.MailContactTable;
import com.quathar.app.gui.table.TelephoneContactTable;
 ...
 * @author Q
 */
public class ContactBook extends JFrame implements ActionListener, DocumentListener, FocusListener { // CLASE FINALIZADA
	 ...
	 */
	public ContactBook(int themeIndex, String themeType) {
		super(FrameTitle);
		dao = new DAO();
	...
	private void crudAction(int i) {
		...
		switch (i) {
			...
			case 1:
				if (selectedRowCount > 0) {
					if (selectedRowCount == 1) {
						...
						new Info(this, dao, id).setVisible(true);
					} else
			...
			case 2:
				setVisible(false);
				new Add(this, dao).setVisible(true);
				break;
		}
	}
