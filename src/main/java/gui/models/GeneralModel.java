 ...
 * GeneralModel.<br><br>
 * 
 * Clase abstracta con métodos comunes para los modelos:<br><br>
 * 
 *  - ContactModel<br>
 *  - HobbyModel<br>
...
public abstract class GeneralModel extends DefaultTableModel { // CLASE FINALIZADA
	...
	// MÉTODOS
	/**
	 * Llena el modelo con la información contenida en el array bidimensional.
	 * 
	...
	/**
	 * Crea las dimensiones del modelo y lo llena de información.
	 * 
	...
	/**
	 * Crea el modelo de información a partir de una tabla en la BBDD.
	 * 
	...
	/**
	 * Crea el modelo de información a partir de una tabla en la BBDD y el ID de un contacto.
	 * 
	 * @param table the table whose information is required
	 * @param columnCount the number of columns in the model
	 * @param id contact ID
	 ...
	 * porque cuando se utiliza el método removeRow() las filas con mayor número de fila cambian su número
