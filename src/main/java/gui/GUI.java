...
import gui.components.RoundJTextField;
import gui.games.TresEnRaya;
import gui.components.ChangerComboBox;
import gui.tables.ContactHobbyTable;
import gui.tables.ContactTable;
import gui.tables.HobbyTable;
import gui.tables.MailContactTable;
import gui.tables.TelephoneContactTable;
import gui.themes.Themes;

import io.MSG;

import main.Agenda_Ejecutable;

/**
 * <b>GUI</b>.<br><br>
 * 
 * Interfaz gráfica de usuario (ventana principal).<br>
 * Clase utilizada para que el usuario interactúe gráficamente con la agenda.<br><br>
 * 
...
public class GUI extends JFrame implements ActionListener, DocumentListener, FocusListener { // CLASE FINALIZADA
	...
	/**
	 * Título de los botones del menú (btnMenu).
	 */
	...
	/**
	 * Título de los items del desplegable tipoContacto.
	 */
	private final String[] TipoContactoTitle = {"TODOS", "PERSONAS", "EMPRESAS", "MASCOTAS"};
	/**
	 * Título de los botones del CRUD (btnCRUD).
	 */
	private final String[] CRUDTitle = {"ELIMINAR", "CONSULTAR", "AÑADIR"};
	/**
	 * Iconos de de estrella.
	 */
	private final String StarSymbols = "\uE113 \uE113 \uE113 \uE113 \uE113";
	/**
	 * Título de los botones del CD (btnCD).
	 */
	 ...
	 */
	private final String HobbyDefaultText = "Busca una afición...";
	/**
	 * Texto por defecto del txtCD de la vista Aficiones.
	 */
	private final String HobbyTxtDefaultText = "Añade una afición...";
	...
	// --VISTA SETTINGS
	/**
	 * Icono del botón del tema en la vista Configuación.
	 */
	private String btnThemeTitle;
	/**
	 * Botón para cambiar entre temas claros y oscuros.
	 */
	private JButton themesButton;
	/**
	 * Componente JComboBox<String> para seleccionar el Tema de la vista Configuración.
	 */
	private ChangerComboBox themesComboBox;
	/**
	 * Botón para acceder a la consola de la vista Configuración.
	 */
	private JButton consoleButton;
	/**
	 * Botón para acceder a juegos de la vista Configuración.
	 */
	private JButton gamesButton;
	/**
	 * Botón para formatear la agenda de la vista Configuración.
	 */
	private JButton formatButton;
	/**
	 * Componente JTable para visualizar los contactos con sus teléfonos.
	 */
	...
	/**
	 * Selecciona el icono del botón de temas y selecciona el tema actual.
	 * 
	 * @param themeIndex the new theme's index
	 * @param themeType the new theme's type
	 */
	...
	/**
	 * Crea un nuevo GridBagLayout con el número columnas y filas pasadas por parámetro.
	 * 
	 * @param columns the layout's number of columns
	 * @param rows the layout's number of rows
	...
	/**
	 * Crea un nuevo GridBagLayout con el número columnas y filas pasadas por parámetro.<br>
	...
	/**
	 * Crea unas nuevas GridBagConstraints para un componente ubicandolo en la posición pasada por parámetro.
	 * 
	...
	// <<ZONA DE DISEÑO>>
	/**
	 * Diseña y crea los componentes de la GUI.
	 */
	...
	/**
	 * Diseña y crea el menú de la GUI.
	 */
	...
	/**
	 * Diseña y crea las <b>vistas</b> de la GUI.
	 */
	...
	/**
	 * Diseña y crea la <b>vista Contactos</b>.
	 */
	...
	/**
	 * Diseña y crea la <b>vista Aficiones</b>.
	 */
	...
	/**
	 * Diseña y crea la <b>vista Configuración</b>.
	 */
	private void createSettingsView() {
		...
		// CENTER - TABLAS TELÉFONOS Y CORREOS
	...
	/**
	 * Define acciones para los botones del menú.
	 * 
	...
	/**
	 * Revisa el botón CRUD de la vista contactos que ha sido pulsado.
	 * 
	 * @param event the event source
	 * @return true/false - if the event source is/isn't on this method
	 */
			...
			case 1:
				if (selectedRowCount > 0) {
					if (selectedRowCount == 1) {
						...
						MSG.warningMessage("No se puede consultar más de 1 contacto a la vez");
				}
				break;
			case 2:
				setVisible(false);
		...
		if (btnCD[0] == event || hobbiesTextField == event) {
			...
			if (rowCount > 0) {
				String msg = (rowCount == 1 ?
						"¿Está seguro de que quiere borrar esta afición?": 
						"¿Está seguro de que quiere borrar " + rowCount + " aficiones?");
	...
	// --LISTENER VISTA CONFIGURACIÓN
	/**
	 * Define acciones para los componentes de la <b>vista Configuración</b>.
	 * 
	 * @param event the event source
	 */
	...
	/**
	 * Define la acción para el desplegable TEMAS.
	 * 
	 * @param event  the event source
	 * @return true/false - if the event source is/isn't on this method
	 */
	...
	/**
	 * Define la acción para el botón Consola.
	 * 
	 * @param event the event source
	 * @return true/false - if the event source is/isn't on this method
	 */
	...
	/**
	 * Define la acción para el botón Juegos.
	 * 
	 * @param event the event source
	 * @return true/false - if the event source is/isn't on this method
	 */
	...
	/**
	 * Define la acción para el botón Formatear.
	 * 
	 * @param event the event source
	 * @return true/false - if the event source is/isn't on this method
	 */
	private boolean listenerFormatear(Object event) {
		if (formatButton == event && MSG.defaultOptionMessage("¿Está seguro de que quiere FORMATEAR la agenda?\n"
				+ "ESTA ACCIÓN NO SE PUEDE REVERTIR") == 0) {
				dispose();
	...
	public void changedUpdate(DocumentEvent e) {
		MSG.questionMessage("changeUpdate(DocumentEvent e) apareció por fin");
	}
