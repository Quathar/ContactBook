...
/**
 * Juego del Tres en raya con entorno gráfico de la GUI.
 * 
 * @since 2022-04-01
 * @author Q
 */
public class TresEnRaya extends JFrame implements ActionListener { // CLASE FINALIZADA
	...
	private void createBoard() {
		...
		setBounds(	(int) (GUI.ScreenSize.width * 0.422),
					(int) (GUI.ScreenSize.height * 0.4),
					(int) 300,
					(int) 300 );
		setResizable(false);
