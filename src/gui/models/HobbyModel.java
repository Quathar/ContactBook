 ...
 * HobbyModel.<br><br>
 * 
 * Modelo que maneja información de la tabla <b>aficiones</b> en la BBDD.
 *
 * @since 2022-04-19
 * @see GeneralModel
 * @see GUI
...
public class HobbyModel extends GeneralModel { // CLASE FINALIZADA
	 ...
	 */
	private final String[] ColumnNames = {"ID", "AFICIÓN"};
	...
	/**
	 * Comprueba el número Stops cuando se intentan borrar aficiones.
	 * 
	...
	private void checkStops(int stop) {
		if (stop > 0) {
			String[] msg = {
					"Está intentando borrar 1 afición utilizada",
					"Está intentando borrar " + stop + " aficiones utilizadas"
			};
	...
	/**
	 * Elimina las filas seleccionadas en el modelo o en el modelo y la BBDD, dependiendo de su ID de afición.
	 * 
	 * @param selectedRows the selected rows
	 */
