...
import gui.ContactInfo;
import gui.models.HobbyModel;
import gui.models.MailModel;
import gui.models.TelephoneModel;
 ...
 * - Crea objetos de tipo contacto y los añade, modifica o elimina en la BBDD<br>
...
public class DAO { // CLASE FINALIZADA
	...
	/**
	 * Inserta una nueva afición a la BBDD.
	 * 
	...
	/**
	 * Devuelve un array bidimensional con toda la información de una tabla.
	 * 
	...
	/**
	 * Devuelve un array bidimensional con toda la información de una tabla a partir de un ID.
	 * 
	 * @param table the table whose information is required
	 * @param columnCount the table's number of columns
	 * @param id_c the contact ID
	...
	/**
	 * Devuelve un array bidimensional con toda la información de una tabla a partir de un nombre o un afición.
	 * 
	...
	/**
	 * Devuelve un array bidimensional con toda la información de la tabla <b>'telefonos'</b>.
	 * 
	 * @param columnCount the table's number of columns
	 * @return the information in an bidimensional array
	 */
	...
	/**
	 * Devuelve un array bidimensional con toda la información de la tabla <b>'correos'</b>.
	 * 
	 * @param columnCount the table's number of columns
	 * @return the information in an bidimensional array
	 */
	...
	/**
	 * Comprueba que el ID del hobby pasado no esté en la tabla <b>'contactos_aficiones'</b>
	 * 
	...
	public boolean checkIdH(int id_h) {
		try {
			...
			// 0 Significa que no está, 1 que sí
			int logic = 0;
			while (rs.next())
				logic = rs.getInt(1);
			if (logic == 1)
	...
	/**
	 * Modifica una afición en la BBDD.
	 * 
	 * @param id_h the hobby ID
